        ...
        <form id="form1" runat="server" class="border p-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-sm-12">
                    ...
                    <p>This sample shows how to export PDF document into Jpeg(s) in memory.</p>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-4 col-md-6 col-sm-12">
                            <asp:Button CssClass="btn btn-primary" ID="Button1" runat="server" OnClick="Button1_Click" Text="Export to Jpeg"/>
